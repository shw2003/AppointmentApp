...
const Contact = () => {
  return (
    <div>
      <section id="contact" className="overflow-hidden px-10">
              ...
              <div className="my-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">1800-890-2102</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-cyan-700 border-cyan w-full rounded border p-3 text-black transition"
                    >
                      Send Message
                    </button>
                  </div>
